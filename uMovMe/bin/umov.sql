...
GRANT ALL ON MGWEB.ven_itempedidovenda TO MEGAUMOV;
...
create or replace trigger VEN_TRA_ITEMPEDIDOVENDAPRECO
  before insert on MGWEB.ven_itempedidovenda  
  for each row
begin
