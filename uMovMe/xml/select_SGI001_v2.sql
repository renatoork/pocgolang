...
--txt
SELECT 'C'||CHR(10)||'command;description;alternativeIdentifier;group;active' FROM dual
UNION ALL
SELECT DISTINCT 'I;'||gru_St_nome||';'||Gru_in_codigo||';'||Gru_St_Defitem||';1' FROM vendas
